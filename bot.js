...
cclient.on('message', async msg => {
    if (msg.author.id === midi || msg.author.id === "411137717884289024" || msg.member.roles.some(r => ["Logan DJ", "The Music Meister"].includes(r.name))) {
...
.addField("Logans Server","https://discord.gg/9VnWey")
    .addField("The Music Setup was taken from","**Logan**: [Invite](https://discordapp.com/api/oauth2/authorize?client_id=489487215270035466&permissions=2146958839&scope=bot)");
